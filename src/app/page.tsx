  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#fafafa] font-sans selection:bg-[#D3FB52] selection:text-black antialiased overflow-x-hidden">
      {/* ─────────────────────────────────────────────────────────────
          HEADER
         ───────────────────────────────────────────────────────────── */}
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-[#0a0a0a]/75 border-b border-white/[0.05]">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center -ml-1">
            <Logo />
          </Link>
          <nav className="hidden md:flex items-center gap-9 text-[13px] text-white/55">
      ...
      <main>
        ...
        <section ref={heroRef} className="relative overflow-hidden pt-40 lg:pt-48 pb-28 lg:pb-36 px-6 lg:px-8">
          ...
          <div className="relative z-10 max-w-[1320px] mx-auto">
            <motion.div
              ...
              className="flex items-center gap-2.5 text-[11px] uppercase tracking-[0.22em] text-white/40 mb-12"
            >
            ...
            <motion.p
              ...
              className="mt-12 lg:mt-14 max-w-[560px] text-[17px] lg:text-[19px] text-white/55 leading-[1.55]"
            >
              {es
        ...
        {/* ───────────────────────────────────────────────────────────
            TRUSTED LOGOS — quiet, monochrome
           ─────────────────────────────────────────────────────────── */}
        <section className="pb-32 lg:pb-40 px-6 lg:px-8">
          <div className="max-w-[1320px] mx-auto">
            <div className="text-[11px] uppercase tracking-[0.22em] text-white/30 mb-10">
              {t.trustedBy}
            </div>
        ...
        {/* ───────────────────────────────────────────────────────────
            PRODUCT VALUE PROP — editorial two-column
           ─────────────────────────────────────────────────────────── */}
        <section id="product" className="px-6 lg:px-8 py-32 lg:py-44">
          <div className="max-w-[1320px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              <div className="lg:col-span-5">
                <div className="text-[11px] uppercase tracking-[0.22em] text-white/40 mb-8">
            ...
            <div className="mt-24 lg:mt-32 grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 border-t border-white/[0.06] pt-12 lg:pt-16">
              {[
                ...
                >
                  ...
                  <div className="text-[13px] text-white/45 leading-snug max-w-[180px]">
                    {s.label}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="max-w-[1320px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06] border border-white/[0.06] rounded-2xl overflow-hidden">
              {[
                ...
                >
                  <div className="font-serif text-[26px] text-white/30 mb-16 tracking-[0.05em]">
                    {step.num}
                  </div>
                  <h3 className="font-serif font-normal text-[28px] lg:text-[32px] text-white tracking-[-0.015em] leading-[1.1] mb-5">
                    {step.title}
                  </h3>
                  <p className="text-white/50 leading-[1.6] text-[15px]">{step.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-[1320px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
              ...
              >
                ...
                >
                  <div className="text-[11px] uppercase tracking-[0.22em] text-white/40 mb-14">
                    {t.roleSplitBadgeCandidate}
                  </div>
                  <h3 className="font-serif font-normal text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.025em] mb-8 max-w-[14ch]">
                    {t.roleSplitTitleCandidate}
                  </h3>
                  <p className="text-[15px] lg:text-[16px] text-white/55 leading-[1.6] max-w-md mb-14">
        ...
        <section className="px-6 lg:px-8 py-32 lg:py-48">
          <div className="max-w-[1080px] mx-auto">
            <div className="text-[11px] uppercase tracking-[0.22em] text-white/40 mb-12">
        ...
        {/* ───────────────────────────────────────────────────────────
            SUPPORTING TESTIMONIALS — small grid
           ─────────────────────────────────────────────────────────── */}
        <section className="px-6 lg:px-8 py-32 lg:py-40">
          <div className="max-w-[1320px] mx-auto">
        ...
        <section className="px-6 lg:px-8 py-32 lg:py-40">
          <div className="max-w-[1080px] mx-auto">
            ...
            <p className="text-white/50 text-[16px] lg:text-[17px] mb-16 max-w-xl">
              {t.comparisonSub}
            </p>
            ...
            <div className="border-t border-white/[0.08]">
              <div className="grid grid-cols-[1.6fr_1fr_1fr] items-center py-5 px-2">
                ...
                <div className="text-center text-[13px] text-white/35">HireVue</div>
              </div>
              {[
                ...
                >
                  ...
                  <div className="text-center">
                    {row.type === 'icon' ? (
                      row.us === 'yes' ? (
                        ...
                        <Minus className="w-4 h-4 text-white/30 inline" />
                      )
                    ) : (
                  ...
                  <div className="text-center text-white/40">
                    {row.type === 'icon' ? (
                      row.them === 'yes' ? (
                        <Check className="w-4 h-4 text-white/40 inline" strokeWidth={2} />
                      ) : row.them === 'limited' ? (
                        <Minus className="w-4 h-4 text-white/30 inline" />
                      ) : (
        ...
        <section id="roles" className="px-6 lg:px-8 py-32 lg:py-44">
          <div className="max-w-[1320px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 lg:mb-20">
              ...
              <p className="text-white/50 text-[15px] lg:text-[16px] max-w-sm">{t.viewOpenRoles}</p>
            </div>
            ...
            {roles.length === 0 ? (
              <div className="border border-white/[0.07] rounded-2xl py-20 px-8 text-center">
                ...
                <p className="text-white/40 text-[15px]">{t.noRoles}</p>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="inline-flex items-center gap-2 text-[13px] text-white/55 shrink-0">
            ...
            >
              {es ? (
                <>
                  Contrata
                  <br />
                  <em className="font-serif italic text-white/45">de otra forma.</em>
                </>
              ) : (
                <>
                  Hire
                  <br />
                  <em className="font-serif italic text-white/45">differently.</em>
                </>
              )}
            </motion.h2>
        ...
        <div className="max-w-[1320px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 lg:gap-12 mb-16">
            <div className="col-span-2 md:col-span-2">
              <Logo />
              <p className="text-[14px] text-white/45 mt-6 max-w-xs leading-[1.65]">
                {es
            ...
            <div>
              <div className="text-[11px] uppercase tracking-[0.18em] text-white/30 mb-5">
                {es ? 'Producto' : 'Product'}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-[14px]">
                ...
                <li>
                  <a href="#" className="text-white/65 hover:text-white transition-colors">
                    {es ? 'Contacto' : 'Contact'}
                  </a>
                </li>
              </ul>
            ...
            <div>
              <div className="text-[11px] uppercase tracking-[0.18em] text-white/30 mb-5">Legal</div>
              <ul className="space-y-3 text-[14px]">
                <li>
          ...
          <div className="pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4 text-[12px] text-white/40">
            <p>
      ...
      <style jsx global>{`
        .font-serif {
          font-family: var(--font-instrument-serif), 'Iowan Old Style', 'Apple Garamond',
