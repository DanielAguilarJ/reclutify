...
export function ProfileExperienceSection({ experience }: ProfileExperienceSectionProps) {
  ...
  return (
    <section className="bg-card rounded-2xl p-6 md:p-8 shadow-sm border border-border">
      <h2 className="text-lg font-bold text-foreground mb-5">Experiencia</h2>
      ...
      <div className="space-y-6">
        {experience.map((exp, index) => (
          <div key={exp.id || index} className="relative flex gap-4">
            ...
            {/* Company icon */}
            <div className="shrink-0 w-10 h-10 rounded-xl bg-primary-light
              border border-primary/20 flex items-center justify-center z-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-muted/70 text-sm mt-0.5">
